export default function Hero() {
  return (
    <section
      id="inicio"
      className="relative min-h-screen [@media(max-width:632px)]:h-[20vh] sm:h-[30vh] lg:h-[120vh] flex items-center justify-center overflow-hidden pt-2 md:pt-0 lg:pt-0"
    >
      <div
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center py-12 sm:pt-0 lg:pt-90 sm:p-[140] [@media(max-width:1023px)]:pt-[2px]">
        {/* Contenido de texto */}
        <div className="animate-fade-in-up text-center lg:text-left">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-6xl xl:text-7xl font-extrabold text-gray-900 leading-tight mt-3 mb-4 sm:mb-6">
            Marca tu{' '}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-weprom-pink to-purple-600 animate-gradient-x">
              Estilo
            </span>
          </h1>
          <p className="text-base sm:text-lg text-gray-600 mb-6 sm:mb-8 max-w-lg mx-auto lg:mx-0 animate-fade-in animation-delay-300 px-4 sm:px-0">
        ...
        {/* Imagen móvil/tablet (opcional) */}
        <div className="lg:hidden relative animate-fade-in animation-delay-700 px-4 mt-6">
          <img
