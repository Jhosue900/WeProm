        ...
        >
          ...
          <div className="grid grid-cols-3 gap-4 pt-8 animate-fade-in animation-delay-700">
            <div className="text-center border-l-2 border-weprom-red pl-4">
              <div className="text-2xl sm:text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-b from-weprom-red to-weprom-red/80">
                500+
              </div>
              <div className="text-xs sm:text-sm text-weprom-gray-500 font-light">
                Productos
              </div>
            </div>

            <div className="text-center border-l-2 border-weprom-blue pl-4">
              <div className="text-2xl sm:text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-b from-weprom-blue to-weprom-blue/80">
                1000+
              </div>
              <div className="text-xs sm:text-sm text-weprom-gray-500 font-light">
                Clientes
            ...
            <div className="text-center border-l-2 border-weprom-green pl-4">
              <div className="text-2xl sm:text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-b from-weprom-green to-weprom-green/80">
                24/7
              </div>
              <div className="text-xs sm:text-sm text-weprom-gray-500 font-light">
                Soporte
        ...
        >
          <div className="relative group">
            ...
            <img
              ...
              alt="Producto Hero"
              className="rounded-3xl shadow-xl transform rotate-[-6deg] hover:rotate-0 hover:scale-105 transition-all duration-500 w-full max-w-lg mx-auto filter grayscale hover:grayscale-0 border-2 border-weprom-gray-800"
            />
